...
;https://www.example.com/firstpage.html
PAG := "Comic Title"
URL := "https://www.example.com/firstpage.html"
CTR := 1
URI := "https://www.example.com"
RE1 := "RegEx for Next Link"
RE2 := "RegEx for Img Link"
OLD := CTR
UPD := True
LOC := "D:\Comics\_Read_\Webcomics\"
global TXT := "Running...`n`n"

Gui, WebComic:New, +ToolWindow +Owner
Gui, Font, s9, ProFontWindows
Gui, Add, Edit, x0 y0 w600 h200 vEDT ReadOnly Center VScroll, %TXT%
Gui, Show, w600 h200, WebComic
...
TextAdd(TEX) {
	TXT := % TXT TEX "`n"
	GuiControl,WebComic:,EDT ,%TXT%
	ControlSend Edit1, ^{End}, A
	return TXT
}

GrabPage(URL) {
	TMP := A_Temp "\WebComic.txt"
